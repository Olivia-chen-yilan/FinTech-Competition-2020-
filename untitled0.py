...
# -*- coding: utf-8 -*-
"""
Created on Tue May 12 14:00:32 2020
...
# 数据清洗后的结果导入
data_cleaned = pd.read_csv('/Users/oliviachen/Desktop/FinTech1/训练数据集/output.csv')
...
# 评分数据集导入
x_predict = pd.read_csv('/Users/oliviachen/Desktop/FinTech1/评分数据集/output.csv') #此处修改为评分数据集处理后的csv位置
