# -*- coding: utf-8 -*-
#https://blog.csdn.net/xuyaoqiaoyaoge/article/details/82860317
...
def svm_train(x_train, y_train):
    ...
    model = svm.SVC(C=0.8, kernel='rbf', gamma='auto', decision_function_shape='ovr', cache_size=500)

    model.fit(x_train, y_train)
    joblib.dump(model, 'Eval_svm.model')
    return model
...
def svm_eval(x_train, y_train, x_test, y_test):
    ...
    :return:
    """
    model = joblib.load('Eval_svm.model')
...
if __name__ == '__main__':
    ...
    x_train, y_train, x_test, y_test = svm_train(data_train, data_test)
